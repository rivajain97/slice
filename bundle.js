...
/* Reflection
For this project I wanted to explore the idea of breaking and rebuilding text. 
The core techniques come from class: drawing text, clipping shapes, adding colour,
using Math.random(), and animating with canvas-sketch. From there, I built upward
by extending clipping into a slicing action. Each slice splits the word into 
fragments that move with simple physics - velocity, rotation, and gravity.
My struggle was getting swipes to create consistent fragments without crashing 
the canvas. Fixing one issue always created another, so it became an iterative 
process of testing and adjusting. This assignment helped me connect many small 
skills from class into one interactive idea and made me realise I understand the 
canvas workflow much more than I thought.
*/
